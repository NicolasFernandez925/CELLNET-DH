							...
							<ul class="page_menu_nav">
								...
								<li class="page_menu_item has-children">
									...
									<ul class="page_menu_selection">
										<li><a href="">Mis datos<i class="fa fa-angle-down"></i></a></li>					
									</ul>
								</li>
							@endif
...
@section('content')
    <div class="container">	
		...
		<div class="row">
			<div class="col-12">
            	<form action="{{route('producto.update.inventario',$producto->id)}}" enctype="multipart/form-data" method="POST" class="form-inventario">
					{{ csrf_field() }}
                    @method('PUT');	  
                    @include('partials/form',['modo' =>'editar']);
                </form>            
            </div>
        </div>
    </div>
